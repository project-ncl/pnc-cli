...
class BuildconfigurationsApi(object):
    ...
    def build(self, id, build_configuration_revision, build_task_id, submit_time_millis, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.build(id, build_configuration_revision, build_task_id, submit_time_millis, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int id: Build Configuration id (required)
        :param str build_configuration_revision: Build Configuration revision (required)
        :param str build_task_id: Build task id (required)
        :param str submit_time_millis: BuildTask submit time in number of millis since epoch. (required)
        :param str build_set_task_id: Build set task id
        :param str callback_url: Optional Callback URL
