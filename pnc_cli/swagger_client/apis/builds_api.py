...
class BuildsApi(object):
    ...
    def cancel(self, id, **kwargs):
        ...
        resource_path = '/builds/{id}/cancel'.replace('{format}', 'json')
        method = 'POST'
    ...
    def get_all(self, **kwargs):
        ...
        resource_path = '/builds'.replace('{format}', 'json')
        method = 'GET'
    ...
    def get_specific(self, id, **kwargs):
        ...
        resource_path = '/builds/{id}'.replace('{format}', 'json')
        method = 'GET'
    ...
    def get_ssh_credentials(self, id, **kwargs):
        ...
        resource_path = '/builds/ssh-credentials/{id}'.replace('{format}', 'json')
        method = 'GET'
