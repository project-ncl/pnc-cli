...
class RunningbuildrecordsApi(object):
    ...
    def get_count(self, **kwargs):
        """
        Gets count of running, enqueued, and 'awaiting for dependencies' Build Records
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_count(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :return: RunningBuildsCountRest
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_count_with_http_info(**kwargs)
        else:
            (data) = self.get_count_with_http_info(**kwargs)
            return data

    def get_count_with_http_info(self, **kwargs):
        """
        Gets count of running, enqueued, and 'awaiting for dependencies' Build Records
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_count_with_http_info(callback=callback_function)
        ...
        return self.api_client.call_api('/running-build-records/count', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='RunningBuildsCountRest',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
