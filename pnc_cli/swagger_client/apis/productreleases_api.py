...
class ProductreleasesApi(object):
    ...
    def create_new_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/product-releases', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_all_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/product-releases', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_all_builds_in_distributed_recordset_of_product_release(self, id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_all_builds_in_distributed_recordset_of_product_release_with_http_info(id, **kwargs)
        else:
            (data) = self.get_all_builds_in_distributed_recordset_of_product_release_with_http_info(id, **kwargs)
            return data

    def get_all_builds_in_distributed_recordset_of_product_release_with_http_info(self, id, **kwargs):
        """
        Gets all BuildRecords distributed for Product Version
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_all_builds_in_distributed_recordset_of_product_release_with_http_info(id, callback=callback_function)
        ...
        return self.api_client.call_api('/product-releases/{id}/distributed-build-records-ids', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_all_by_product_version_id_with_http_info(self, version_id, **kwargs):
        ...
        return self.api_client.call_api('/product-releases/product-versions/{versionId}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_all_support_level_with_http_info(self, **kwargs):
        """
        Gets all Product Releases Support Level
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_all_support_level_with_http_info(callback=callback_function)
        ...
        return self.api_client.call_api('/product-releases/support-level', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_specific_with_http_info(self, id, **kwargs):
        ...
        return self.api_client.call_api('/product-releases/{id}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_with_http_info(self, id, **kwargs):
        ...
        return self.api_client.call_api('/product-releases/{id}', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
