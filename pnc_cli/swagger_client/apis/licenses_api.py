...
class LicensesApi(object):
    ...
    def create_new_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/licenses', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='LicenseSingleton',
    ...
    def delete_with_http_info(self, id, **kwargs):
        ...
        return self.api_client.call_api('/licenses/{id}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_specific_with_http_info(self, id, **kwargs):
        ...
        return self.api_client.call_api('/licenses/{id}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_with_http_info(self, id, **kwargs):
        ...
        return self.api_client.call_api('/licenses/{id}', 'PUT',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
