...
class BuildconfigsetrecordsApi(object):
    ...
    def get_all_temporary_older_than_timestamp(self, **kwargs):
        """
        Gets the temporary Build Config Set Records, which were built before a timestamp set by parameter
    ...
    def get_all_temporary_older_than_timestamp_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/build-config-set-records/temporary-older-than-timestamp', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
