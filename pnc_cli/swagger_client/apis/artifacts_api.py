...
class ArtifactsApi(object):
    ...
    def get_all(self, **kwargs):
        ...
        :param str sha256: Filter by sha256 of the artifact
        :param str md5: Filter by md5 of the artifact
        :param str sha1: Filter by sha1 of the artifact
        :return: ArtifactPage
    ...
    def get_all_with_http_info(self, **kwargs):
        ...
        all_params = ['page_index', 'page_size', 'sort', 'q', 'sha256', 'md5', 'sha1']
        ...
        return self.api_client.call_api('/artifacts', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_specific(self, id, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int id: Artifact id (required)
    ...
    def get_specific_with_http_info(self, id, **kwargs):
        ...
        return self.api_client.call_api('/artifacts/{id}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='ArtifactSingleton',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
