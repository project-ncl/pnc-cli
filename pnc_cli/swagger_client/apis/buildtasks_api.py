...
class BuildtasksApi(object):
    ...
    def build(self, build_execution_configuration, **kwargs):
        """
        Cancel the build execution defined with given configurationId.
        ...
        :param int build_execution_configuration: Build Execution Configuration ID. See org.jboss.pnc.spi.executor.BuildExecutionConfiguration. (required)
        :return: None
        ...
        all_params = ['build_execution_configuration']
        ...
        resource_path = '/build-tasks/cancel-build/{id}'.replace('{format}', 'json')
        method = 'POST'

        path_params = {}
        if 'build_execution_configuration' in params:
            path_params['buildExecutionConfiguration'] = params['build_execution_configuration']
