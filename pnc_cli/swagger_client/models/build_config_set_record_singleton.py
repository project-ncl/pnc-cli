...
class BuildConfigSetRecordSingleton(object):
    """
    ...
    def __init__(self, content=None):
        """
        BuildConfigSetRecordSingleton - a model defined in Swagger
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, BuildConfigSetRecordSingleton):
            return False
