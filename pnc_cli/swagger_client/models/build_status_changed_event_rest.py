...
class BuildStatusChangedEventRest(object):
    ...
    def old_status(self, old_status):
        ...
        :type: str
        """
        allowed_values = ["NEW", "WAITING_FOR_DEPENDENCIES", "REPO_SETTING_UP", "BUILD_ENV_SETTING_UP",
                          "BUILD_ENV_WAITING", "BUILD_ENV_SETUP_COMPLETE_SUCCESS",
                          "BUILD_ENV_SETUP_COMPLETE_WITH_ERROR", "BUILD_SETTING_UP", "BUILD_WAITING",
                          "BUILD_COMPLETED_SUCCESS", "BUILD_COMPLETED_WITH_ERROR",
                          "COLLECTING_RESULTS_FROM_BUILD_DRIVER", "COLLECTING_RESULTS_FROM_REPOSITORY_NAMAGER",
                          "BUILD_ENV_DESTROYING", "BUILD_ENV_DESTROYED", "STORING_RESULTS", "DONE", "REJECTED",
                          "REJECTED_ALREADY_BUILT", "SYSTEM_ERROR", "DONE_WITH_ERRORS"]
