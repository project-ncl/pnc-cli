...
class Environment(object):
    ...
    def build_type(self):
        """
        Gets the build_type of this Environment.


        :return: The build_type of this Environment.
        :rtype: str
        """
    ...
    def build_type(self, build_type):
        """
        Sets the build_type of this Environment.


        :param build_type: The build_type of this Environment.
        :type: str
        """
    ...
    def operational_system(self):
        """
        Gets the operational_system of this Environment.


        :return: The operational_system of this Environment.
        :rtype: str
        """
    ...
    def operational_system(self, operational_system):
        """
        Sets the operational_system of this Environment.


        :param operational_system: The operational_system of this Environment.
        :type: str
        """
        allowed_values = ["WINDOWS", "LINUX", "OSX"]
        if operational_system not in allowed_values:
            raise ValueError(
                "Invalid value for `operational_system`, must be one of {0}"
                .format(allowed_values)
            )
