...
parser.add_commands([uc.login,
                     ...
                     buildrecords.list_built_artifacts_minimized,
                     buildrecords.list_dependency_artifacts,
                     buildrecords.list_dependency_artifacts_minimized,
                     ...
                     buildrecords.download_scm_sources_for_record,
                     ...
                     bpmbuildconfigurations.create_repository_configuration,
