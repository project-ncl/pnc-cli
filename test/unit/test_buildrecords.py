...
@patch('pnc_cli.buildrecords.pnc_api.builds')
...
@patch('pnc_cli.buildrecords.pnc_api.builds.get_all_for_build_configuration', return_value=MagicMock(content=[2, 3, 4]))
@patch('pnc_cli.buildrecords.pnc_api.build_configs', autospec=BuildconfigurationsApi)
...
@patch('pnc_cli.buildrecords.pnc_api.builds.get_all_for_build_configuration', return_value=MagicMock(content=[1, 2, 3]))
@patch('pnc_cli.buildrecords.pnc_api.build_configs', autospec=BuildconfigurationsApi)
...
@patch('pnc_cli.buildrecords.pnc_api.builds.get_specific', return_value=MagicMock(content='build record 2'))
...
@patch('pnc_cli.buildrecords.pnc_api.builds.get_built_artifacts',
...
@patch('pnc_cli.buildrecords.pnc_api.builds.get_dependency_artifacts',
       return_value=MagicMock(content=['artifact1', 'artifact2']))
...
@patch('pnc_cli.buildrecords.pnc_api.builds.get_build_configuration_audited', return_value=MagicMock(content='audited bc'))
...
@patch('pnc_cli.buildrecords.pnc_api.builds.get_logs', return_value='log here.')
...
@patch('pnc_cli.buildrecords.pnc_api.builds.remove_attribute')
...
@patch('pnc_cli.buildrecords.pnc_api.builds.query_by_attribute', return_value=MagicMock(content=MagicMock(attributes={"key":"value"})))
...
@patch('pnc_cli.buildrecords.pnc_api.builds.get_attributes', return_value=MagicMock(content=MagicMock(attributes={'key1':'value1','key2':'value2'})))
