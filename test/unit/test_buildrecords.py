...
def test_list_build_records(mock_records_api):
    ...
    mock_records_api.get_all.assert_called_once_with(page_size=200, q="", sort="")
    assert result == [1, 2, 3]
...
def test_list_records_for_build_configuration_id(mock_configs_api, mock_records_api, mock_set_id):
    ...
    mock_records_api.assert_called_once_with(configuration_id='1', page_size=200, q="", sort="")
    assert result == [2, 3, 4]
...
def test_list_records_for_build_configuration_name(mock_configs_api, mock_records_api, mock_set_id):
    ...
    mock_records_api.assert_called_once_with(configuration_id=2, page_size=200, q="", sort="")
    assert result == [1, 2, 3]
...
def test_list_records_for_project_id(mock_projects_api, mock_records_api, mock_set_id):
    ...
    mock_records_api.assert_called_once_with(project_id='1', page_size=200, q="", sort="")
    assert result == [1]
...
def test_list_records_for_project_name(mock_projects_api, mock_records_api, mock_set_id):
    ...
    mock_records_api.assert_called_once_with(project_id='2', page_size=200, q="", sort="")
    assert result == [2]
