...
@patch('pnc_cli.products.pnc_api.products.create_new', return_value=MagicMock(content='SUCCESS'))
...
@patch('pnc_cli.products.pnc_api.products.get_specific')
@patch('pnc_cli.products.pnc_api.products.update', return_value=MagicMock(content='SUCCESS'))
...
@patch('pnc_cli.products.pnc_api.products.get_specific', return_value=MagicMock(content='SUCCESS'))
@patch('pnc_cli.products.pnc_api.products', autospec=ProductsApi)
...
@patch('pnc_cli.common.set_id', return_value=1)
@patch('pnc_cli.products.pnc_api.products.get_product_versions', return_value=MagicMock(content='SUCCESS'))
@patch('pnc_cli.products.pnc_api.products', autospec=ProductsApi)
...
@patch('pnc_cli.products.pnc_api.products.get_all', return_value=MagicMock(content='SUCCESS'))
